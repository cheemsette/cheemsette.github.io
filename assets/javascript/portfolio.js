...
$(document).ready(() => {
  const links = [
    {
      name: '2KS1_ZadaniaHTML',
      link: 'https://cheemsette.github.io/zadania/index.html',
    },
    {
      name: '2KS1_Sprawdzian_Sklep',
      link: 'https://cheemsette.github.io/sprawdzian/index.html',
    },
    {
      name: '2KS2_ZadaniaHTMLCSS',
      link: 'https://cheemsette.github.io/zadania1-5.github.io/',
    },
  ];
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>cheems $$$</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
